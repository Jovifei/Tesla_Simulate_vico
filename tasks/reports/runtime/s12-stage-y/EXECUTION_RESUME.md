...
- Snapshot schema v3 now binds `timbre_layer_coupling`; fitted snapshots cannot restore into legacy coupling. Package renderer config hashes include the same coupling contract.
