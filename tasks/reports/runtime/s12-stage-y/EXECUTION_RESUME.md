...
complete software regression are now PASS;
...
unchanged. Full S12 completed on tested HEAD `a73322b` with `1369 passed, 2
skipped` and exit `0`.
...
- Current phase: `Y9_FINAL_QUALIFICATION` (`PASS`); final fitted-map receipt and full S12 software regression passed.
- Full S12 receipt: `full-s12-final-20260831T170006408730Z`, tested HEAD `a73322b1ceebe700fc97073cbf50cfd12b961bbf`, `1369 passed, 2 skipped`, exit `0`; log SHA is bound in `final_qualification/full_s12_final_receipt.json`.
