...
| ID | 工作 | 状态 | 完成证据 |
|---|---|---|---|
| P0-01 | Re-verify PR #5 exact head / CI | Ready | head 与 successful CI SHA 一致 |
| P0-02 | 正常合并 PR #5 | Pending | merge commit / ancestry / no force |
| P0-03 | Stage AC post-merge truth | Pending | AC6/7/8 receipt + smoke |
