...
| R 差异基线 | `BLOCKED_REFERENCE_QUALIFICATION` | R1/R2 资格门、R2 有限比较入口、R1 SHA-bound MATLAB/MoSQITo 输入准备、执行计划、报告模板和 withheld 推荐 | 未运行合格真实比较 |
...
- 报告绑定代码提交：`1231d183303df33becd37de93b73678891958797`
