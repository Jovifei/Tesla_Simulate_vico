...
| PR #5 hardening | Remote CI green, PR open | head `021fe294...`，run `33703659821` success |
...
CI 33703659821 = SUCCESS on exact head
...
- PR #5: open and mergeable; exact-head CI run `33703659821` succeeded.
