...
def render_stage_l_candidate(trace: VehicleStateTrace, candidate: StageLCandidateProfile) -> SourceRender:
    ...
    legacy = render_legacy_hellcat_raw_with_clock(trace, clock, _SAMPLE_RATE_HZ)
    ...
    final_diagnostics.update(
        {
            ...
            "shared_clock_consumers": {
                "legacy_raw_hemi": {
                    "adapter": "render_legacy_hellcat_raw_with_clock",
                    ...
                    "contract": "phase_and_sample_validation_only",
                    "internal_event_scheduling": "PENDING_L2",
                },
                "stage_k_v4_blower": {
            ...
            "stage_l_l2_event_consumption": "PENDING",
            "pipeline_order": (
...
__all__ = (
    "render_legacy_hellcat_raw_with_clock", "render_stage_k_v4_blower_with_clock",
