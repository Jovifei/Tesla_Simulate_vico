...
s12_git_commit: d33b3ecf3757ffa084aa43277892f012d48ecaa8
...
Current local evidence roots are `bakeoff_final_remediation_v17`,
`migration_final_remediation_rx7_v17`, and
`migration_final_remediation_ferrari_v18`; validators are fail-closed and
selection remains null. The prior Stage-U/R3 packages remain non-R1 because rights, original capture
