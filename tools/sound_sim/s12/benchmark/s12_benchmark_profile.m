...
profile.radiation_boundary_time_domain.grid_cell_counts = ...
    reshape(profile.radiation_boundary_time_domain.grid_cell_counts, 1, []);
profile.radiation_boundary_time_domain.cfl_scan = ...
    reshape(profile.radiation_boundary_time_domain.cfl_scan, 1, []);
profile.radiation_boundary_time_domain.nominal_grid_cell_count = ...
    double(profile.radiation_boundary_time_domain.nominal_grid_cell_count);
profile.radiation_boundary_time_domain.time_convergence_grid_cell_count = ...
    double(profile.radiation_boundary_time_domain.time_convergence_grid_cell_count);
end
