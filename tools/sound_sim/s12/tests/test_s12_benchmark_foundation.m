...
verifyEqual(testCase, string({registry.id}), ...
    ...
    "unflanged_open_end_radiation_impedance", ...
    "radiation_single_tone", "radiation_multisine", ...
    "radiation_chirp", "radiation_pulse", "radiation_limit_open", ...
    "radiation_limit_matched", "radiation_limit_rigid", ...
    "radiation_amplitude_linearity", "radiation_grid_convergence", ...
    "radiation_time_convergence", "radiation_zero_input_decay", ...
    "radiation_retry_rollback"]);
...
verifyEqual(testCase, result.schema_minor, 12);
