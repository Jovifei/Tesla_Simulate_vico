...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Run the synthetic S12 v0.8 Android-protocol WebSocket demo."
    )
    ...
    print(
        f"PCM frames={report.pcm_frame_count} packets={report.packet_count} pcm_sha256={report.pcm_sha256}"
    )
