...
- Y1 canonical probe：历史公式-map 16/16 保留；最终 committed fitted-map 新鲜 receipt `y1-final-fitted-map-20260831T145748162574Z` 为 16/16 bilateral PASS，测试源码 head `59fe45d`，P3 元数据修正 head `4224c196`，artifact SHA `40c5474d`。
