...
- Fresh execution evidence: MATLAB R2026a fixture and 8/8 project-data receipts passed independent immutable-input/path validation; order fixture ridge errors for 0.5/1/4/6 are all below `0.003` against a `0.08` tolerance; all five Audio Toolbox direction gates passed; MATLAB/MoSQITo common-trend validation passed; Stage-N runtime artifact manifest verification is zero-error. Final full S12 regression: `343 passed, 114 subtests passed in 445.42s`.
