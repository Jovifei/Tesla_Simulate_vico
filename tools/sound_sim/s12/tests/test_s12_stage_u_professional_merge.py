...
def test_professional_merge_binds_same_sha_and_reports_candidate_improvement() -> None:
    legacy = [{"reference_id": "r", "candidate_id": "c", "vehicle_id": "hellcat", "scenario": "launch", "parent_distance": 0.50, "candidate_distance": 0.25, "absolute_improvement": 0.25, "relative_improvement": 0.5, "hard_gates_pass": True}]
    matlab = {
        "results": [
...
def test_professional_merge_rejects_sha_mismatch() -> None:
    legacy = [{"reference_id": "r", "candidate_id": "c", "vehicle_id": "hellcat", "scenario": "launch", "parent_distance": 0.5, "candidate_distance": 0.4, "absolute_improvement": 0.1, "relative_improvement": 0.2, "hard_gates_pass": True}]
