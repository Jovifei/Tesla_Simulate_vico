...
from tools.sound_sim.s12.acoustic_identity_v015.stage_m.review_package import build_local_review_package
...
def main() -> int:
    ...
    write_automated_closure(args.runtime, comparison, feedback_schema=feedback_schema, review_package_root=args.review_package)
    return 0
